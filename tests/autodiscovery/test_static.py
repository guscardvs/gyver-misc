...
from gyver.misc.casting import filter_isinstance, filter_issubclass


def test_static_autodiscovery_childof(sample_root_path, mock_module_path: pathlib.Path):
    Test = __import__("tests.autodiscovery.modules.mod_a", fromlist=["Test"]).Test
...
def test_static_autodiscovery_instanceof(
    sample_root_path, mock_module_path: pathlib.Path
):
    Test = __import__("tests.autodiscovery.modules.mod_a", fromlist=["Test"]).Test
    static = autodiscovery.StaticAutoDiscovery(
...
def test_static_autodiscovery_module(sample_root_path, mock_module_path: pathlib.Path):
    static = autodiscovery.StaticAutoDiscovery(
